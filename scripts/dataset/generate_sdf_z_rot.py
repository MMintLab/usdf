...
def generate_sdf_z_rot(dataset_cfg: dict, split: str, vis: bool = False):
    ...
    for idx in trange(len(meshes)):
        ...
        sdf_dict = generate_sdf_data(source_mesh, N_random, N_off_surface, off_surface_sigma_a,
                                     off_surface_sigma_b, vis)

        # Save result.
        mmint_utils.save_gzip_pickle(sdf_dict, os.path.join(example_sdf_dir, "sdf_data.pkl.gzip"))
